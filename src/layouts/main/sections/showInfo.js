...
function ShowValues(results, options, selectedOption, selectedOption_value, setSelectedOption,
    setSelectedOptionValue, setSelectedOptionImprove, selectedOption_improve) {
    ...
    return (
        <>
            <div className="title">
                <div >
                    <Select onChange={ChangeValue}  options={options} placeholder={selectedOption} className="select-search" theme='neutral50' />
                </div>
...
function ShowInfo({results}){
    ...
    const [selectedOption1, setSelectedOption1] = React.useState('میانگین تعداد سطر در فاکتور');
    const [selectedOption1_value, setSelectedOptionValue1] = React.useState(results.date1.factor_rows_average);
    ...
    const [selectedOption2_value, setSelectedOptionValue2] = React.useState(results.date1.factor_product_average);
    ...
    const [selectedOption3_value, setSelectedOptionValue3] = React.useState(results.date1.sale_factor_count);
    ...
    const [selectedOption4_value, setSelectedOptionValue4] = React.useState(results.date1.rejected_factor_count);
    const [selectedOption4_improve, setSelectedOptionImprove4] = React.useState('0');

    const [selectedOption5, setSelectedOption5] = React.useState("میانگین مبلغ فاکتورها");
    const [selectedOption5_value, setSelectedOptionValue5] = React.useState(results.date1.factor_amount_average);
    const [selectedOption5_improve, setSelectedOptionImprove5] = React.useState('0');

    const [selectedOption6, setSelectedOption6] = React.useState("میانگین مبلغ کالاها");
    const [selectedOption6_value, setSelectedOptionValue6] = React.useState(results.date1.factor_amount_product_average);
    const [selectedOption6_improve, setSelectedOptionImprove6] = React.useState('0');
    ...
    useEffect(() => { 
        ...
        if (results.percentage !== undefined){
            setSelectedOptionImprove1(results.percentage[options_keys[selectedOption1]]);
            setSelectedOptionImprove2(results.percentage[options_keys[selectedOption2]]);
            setSelectedOptionImprove3(results.percentage[options_keys[selectedOption3]]);
            setSelectedOptionImprove4(results.percentage[options_keys[selectedOption4]]);
            setSelectedOptionImprove5(results.percentage[options_keys[selectedOption5]]);
            setSelectedOptionImprove6(results.percentage[options_keys[selectedOption6]]);
        }
        else{
    ...
    return(
        <>
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-2 mb-3">
                 {/* {response} */}
         <div className="bg-white rounded-md p-2 cursor-pointer">
                    {ShowValues(results, options, selectedOption1, selectedOption1_value, setSelectedOption1,
                         setSelectedOptionValue1, setSelectedOptionImprove1, selectedOption1_improve)}
                </div>
                <div className="bg-white rounded-md p-2 cursor-pointer">
                    {ShowValues(results, options, selectedOption2, selectedOption2_value, setSelectedOption2,
                        setSelectedOptionValue2, setSelectedOptionImprove2, selectedOption2_improve)}
                </div> 
                 <div className="bg-white rounded-md p-2 cursor-pointer">
                    {ShowValues(results, options, selectedOption3, selectedOption3_value, setSelectedOption3,
                        setSelectedOptionValue3, setSelectedOptionImprove3, selectedOption3_improve)}
                </div> 
                <div className="bg-white rounded-md p-2 cursor-pointer">
                    {ShowValues(results, options, selectedOption4,  selectedOption4_value, setSelectedOption4,
                        setSelectedOptionValue4, setSelectedOptionImprove4, selectedOption4_improve)}
                </div> 
                 <div className="bg-white rounded-md p-2 cursor-pointer">
                    {ShowValues(results, options, selectedOption5, selectedOption5_value, setSelectedOption5,
                        setSelectedOptionValue5, setSelectedOptionImprove5, selectedOption5_improve)}
                </div> 
                <div className="bg-white rounded-md p-2 cursor-pointer">
                    {ShowValues(results, options, selectedOption6, selectedOption6_value, setSelectedOption6,
                        setSelectedOptionValue6, setSelectedOptionImprove6, selectedOption6_improve)}
                </div>
        </div>
