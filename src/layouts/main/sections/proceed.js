    ...
    return (
        <>
            <div className="w-full flex justify-center items-center p-3">
              <div className='w-full bg-white flex flex-col rounded-md overflow-x-auto'>
              <div className="bg-blue-100 mb-4 p-3 flex justify-between items-center">
                    <div className="text">
                        عملکرد مشتریان
                    </div>
                ...
                <div className="chart p-2 ">
                    <div className="w-full md:w-2/5 flex items-center gap-3 mb-4">
                        <div className='w-full flex flex-1'>
                            <Select onChange={ChangeValue1}  options={options} placeholder={selectedOption1} className="w-full" theme='neutral50' />
                        </div>
                        <div className='w-full flex flex-1'>
                            <Select onChange={ChangeValue2}  options={options} placeholder={selectedOption2} className="w-full" theme='neutral50' />
                        </div>
                    </div>
