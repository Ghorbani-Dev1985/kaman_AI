...
<input type={inputType}
        ...
        name={InputName}
        autoComplete="off" 
        className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-navy-500 bg-transparent dark:bg-navy-700 rounded-lg border-1 border-navy-300 appearance-none dark:text-white dark:border-navy-600 dark:focus:border-navy-500 focus:outline-none focus:ring-0 focus:border-navy-600 peer" placeholder=" " />
